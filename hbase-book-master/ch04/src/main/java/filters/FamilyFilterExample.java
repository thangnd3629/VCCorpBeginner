...
//    helper.fillTable("testtable", 1, 10, 2, "colfam1", "colfam2", "colfam3", "colfam4");
    ...
    Filter filter1 = new FamilyFilter(CompareFilter.CompareOp.EQUAL, // co FamilyFilterExample-1-Filter Create filter, while specifying the comparison operator and comparator.
      new BinaryComparator(Bytes.toBytes("colfam3")));

    Scan scan = new Scan();
    scan.setFilter(filter1);
    scan.addColumn(Bytes.toBytes("colfam3"), Bytes.toBytes("col-1"));
